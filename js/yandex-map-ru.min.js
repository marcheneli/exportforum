...
setupAsync({"key":undefined,"apikey":undefined,"browser":{"name":"Chrome","version":"53.0.2785","base":"Chromium","engine":"WebKit","engineVersion":"537.36","osName":"Windows 8.1","osFamily":"Windows","osVersion":"6.3","isMobile":false,"cssPrefix":"Webkit","webglBlacklisted":false},"lang":"ru_RU","languageCode":"ru","countryCode":"RU","hosts":{"api":{"main":"https://api-maps.yandex.ru/","ua":"https://legal.yandex.ru/maps_termsofuse/?lang={{lang}}","maps":"https://yandex.ru/maps/","statCounter":"https://yandex.ru/clck/","services":{"coverage":"https://api-maps.yandex.ru/services/coverage/","geoxml":"https://api-maps.yandex.ru/services/geoxml/","route":"https://api-maps.yandex.ru/services/route/","regions":"https://api-maps.yandex.ru/services/regions/","geocode":"https://geocode-maps.yandex.ru/","suggest":"https://suggest-maps.yandex.ru/","search":"https://api-maps.yandex.ru/services/search/","inception":"https://api-maps.yandex.ru/services/inception/"}},"layers":{"map":"https://vec0%d.maps.yandex.net/tiles?l=map&%c&%l","sat":"https://sat0%d.maps.yandex.net/tiles?l=sat&%c&%l","skl":"https://vec0%d.maps.yandex.net/tiles?l=skl&%c&%l"},"panoramasApi":"https://panoramas.api-maps.yandex.ru/","traffic":"https://jgo.maps.yandex.net/","trafficArchive":"https://jft.maps.yandex.net/"},"layers":{"map":{"version":"4.114.2","scaled":true},"sat":{"version":"3.285.0"},"skl":{"version":"4.114.2","scaled":true},"trf":{"version":"1476126521","scaled":true}},"geolocation":{"longitude":52.39582,"latitude":55.743553,"isHighAccuracy":false,"span":{"longitude":0.365201,"latitude":0.154965}},"token":"927271a318c11f7b137943d051a55dee","sign":(function(r){function t(e){if(n[e])return n[e].exports;var o=n[e]={exports:{},id:e,loaded:!1};return r[e].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=r,t.c=n,t.p="",t(0)})([function(r,t,n){"use strict";function e(){for(var r=["4","9","a","5","f","a","7","9","7","d","2","e","4","8","4","d","b","3","5","4","b","d","7","d","9","3","1","a","9","9","2","7","4","6","0","b","c","4","2","e"],t=[[(function(){var e=document.createElement("a");return e.href="http://defja.co.uk/?MZ1L=0&=yni",e.search.length})()+3,SVGAngle.SVG_ANGLETYPE_UNSPECIFIED+31],[SVGTransform.SVG_TRANSFORM_TRANSLATE+11,DOMException.NOT_SUPPORTED_ERR+23],[Event.CAPTURING_PHASE+26,SVGTransform.SVG_TRANSFORM_ROTATE+35]],n=0;n<t.length;n++){var e=t[n][0],o=t[n][1],i=r[e];r[e]=r[o],r[o]=i}return r.join("")}var o,i=n(1),u=n(2);r.exports=function(r){return o||(o=i(e())),i(u(r),o)}},function(r,t){"use strict";r.exports=function(r,t){t=t||0;for(var n=0;n<r.length;n++)t+=(t<<1)+(t<<4)+(t<<7)+(t<<8)+(t<<24),t^=r.charCodeAt(n);return t>>>0}},function(r,t){"use strict";r.exports=function(r){r=r.replace(/^.*\/\//,"");var t=r.indexOf("?");if(-1===t)return r;var n=t+1,e=r.indexOf("#",n);-1===e&&(e=r.length);var o=r.substring(n,e).split("&",1e3);return r.substring(0,n)+o.sort().join("&")+r.substring(e)}}]),"distribution":{},"version":"2.1.42","majorVersion":"2.1","cssPrefix":"ymaps-2-1-42-","server":{"url":"//api-maps.yandex.ru/2.1.42","path":"./build/release/","params":{},"version":1475068830658},"preload":{"load":"package.full"},"coordinatesOrder":"latlong"});})(this);